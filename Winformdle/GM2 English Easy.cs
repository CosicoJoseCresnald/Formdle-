...
namespace Winformdle
{
    public partial class game2EnglishEasy : Form
    {
        ...
        private void game2EnglishEasy_Load(object sender, EventArgs e)
        {
        ...
        {
            Remove_Character.GM2EnglishRemoveCharEasy();
        }
        ...
        private void confirmBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (guessWordTxt.Text.Length == 5)
                {
                    ...
                    game2EnglishEasyChoicePnl.Visible = false;
                }
                else
                {
        ...
        private void btnBackMainMenu_Click(object sender, EventArgs e)
        {
            ...
            game2EnglishEasyPnl.Visible = false;
        }
