...
{
    public partial class game2EnglishMedium : Form
    {
        public static Dictionary<char, Button> letterButtons { get; private set; }
        public game2EnglishMedium()
        {
            InitializeComponent();
        ...
        {
            Remove_Character.GM2EnglishRemoveCharMedium();
        }
        ...
        private void confirmBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Insufficient characters, the word must contain six(6) characters.");
                }
            }
        }

        private void game2EnglishMedium_Load(object sender, EventArgs e)
        {
        ...
        private void game2EnglishMedium_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
