...
namespace Winformdle
{
    public partial class game2EnglishHard : Form
    {
        ...
        private void game2EnglishEasyPnl_Paint(object sender, PaintEventArgs e)
        {
        ...
        public void backspaceBtn_Click(object sender, EventArgs e)
        {
            Remove_Character.GM2EnglishRemoveCharHard();
        }
        ...
        private void game2EnglishHard_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
