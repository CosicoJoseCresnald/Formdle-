...
{
    public partial class game1EnglishMedium : Form
    {

        public static Dictionary<char, Button> letterButtons { get; private set; }
        public game1EnglishMedium()
        {
            InitializeComponent();
        ...
        private void game1EglishMedium_Load(object sender, EventArgs e)
        {
        ...
        public static List<string> wordInventory = new List<string>() {  "ABOUND", "AMAZED", "ARCHED", "ASCEND", "ASSERT", "ASSIGN",
        ...
        {
            Remove_Character.GM1EnglishRemoveCharMedium();
        }
        ...
        private void attempt1Char1_TextChanged_1(object sender, EventArgs e)
        {

        }

        private void game1EnglishMedium_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void btnAddWordConfirm_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Insufficient characters, the word must contain five(6) characters.");
                }
            }
        }
