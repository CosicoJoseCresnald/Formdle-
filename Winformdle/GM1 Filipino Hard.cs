...
namespace Winformdle
{
    public partial class game1FilipinoHard : Form
    {
        ...
        private void game1FilipinoHard_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
