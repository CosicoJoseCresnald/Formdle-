...
namespace Winformdle
{
    public partial class game1EnglishHard : Form
    {
        ...
        private void game1EnglishHard_Load(object sender, EventArgs e)
        {
        ...
        {
            Remove_Character.GM1EnglishRemoveCharHard();
        }
        ...
        private void game1EnglishHard_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
