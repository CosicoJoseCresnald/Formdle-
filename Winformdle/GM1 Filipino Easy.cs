...
"SUKAT", "SABON", "SABOG", "SAGOT", "SANIB", "SAHOG", "SAKIT", "SAKOP", "SAMPO", "SANDO", "SANHI", "SAPAT", "SAPOT", "SARSA", "SEPAK", "SIBOL", "SIBIL", "SIGLA", "SIKAP",
 "WASER"  };
        ...
        {
            Remove_Character.GM1FilipinoRemoveCharEasy();
        }
        ...
        private void game1FilipinoEasy_Load(object sender, EventArgs e)
        {
        ...
        private void game1FilipinoEasy_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
