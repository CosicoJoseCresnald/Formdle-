...
namespace Winformdle
{
    ...
    public partial class game2FilipinoHard : Form
    {
        public static Dictionary<char, Button> letterButtons { get; private set; }
        public game2FilipinoHard()
        {
            InitializeComponent();
        ...
        private void game2FilipinoHard_Load(object sender, EventArgs e)
        {
        ...
        {
            Remove_Character.GM2FilipinoRemoveCharHard();
        }
        ...
        public async void enterBtn_Click(object sender, EventArgs e)
        {
            ...
            if (attempt1)
            {
                ...
                {
                    MessageBox.Show("Kulang ang mga letra! Pitong(7) Letra lamang! ");
                }
            }
            //attempt2
            else if (attempt2)
            ...
            {
                string attemptWord = attempt5Char1.Text + attempt5Char2.Text + attempt5Char3.Text + attempt5Char4.Text + attempt5Char5.Text + attempt5Char6.Text + attempt5Char7.Text;
                if (attemptWord.Length == 7)
                {

                    Colors.GM2FilipinoHardCheck5();
                    if (attemptWord == guessWord)
                    {
                        await Task.Delay(2500);
                        var win = new WinScreen(guessWord);
        ...
        private void game2FilipinoHard_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }

        private void oBtn_Click_1(object sender, EventArgs e)
        {
            Inputkey("O");
        }
    }
