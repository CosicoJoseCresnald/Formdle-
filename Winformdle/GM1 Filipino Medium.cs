...
namespace Winformdle
{
    public partial class game1FilipinoMedium : Form
    {
        ...
        {
            Remove_Character.GM1FilipinoRemoveCharMedium();
        }
        ...
        public async void enterBtn_Click(object sender, EventArgs e)
        {
            ...
            if (attempt1)
            {
                ...
                {
                    Colors.GM1FilipinoMediumCheck1();
            ...
            else if (attempt2)
            {
                ...
                if (attemptWord.Length == 6)
                {
                    ...
                    Colors.GM1FilipinoMediumCheck2();
                    if (attemptWord == guessWord)
                    {
                        await Task.Delay(2500);
            ...
            else if (attempt3)
            {
                ...
                if (attemptWord.Length == 6)
                {
                    Colors.GM1FilipinoMediumCheck3();
                    if (attemptWord == guessWord)
                    {
                        await Task.Delay(2500);
                        var win = new WinScreen(guessWord);
            ...
            else if (attempt4)
            {
                ...
                if (attemptWord.Length == 6)
                {
                    Colors.GM1FilipinoMediumCheck4();
                    if (attemptWord == guessWord)
                    {
                        await Task.Delay(2500);
                        var win = new WinScreen(guessWord);
            ...
            else if (attempt5)
            {
                ...
                if (attemptWord.Length == 6)
                {
                    ...
                    Colors.GM1FilipinoMediumCheck5();
                    if (attemptWord == guessWord)
                    {
                        await Task.Delay(2500);
                        var win = new WinScreen(guessWord);
            ...
            else if (attempt6)
            {
                ...
                if (attemptWord.Length == 6)
                {
                    ...
                    Colors.GM1FilipinoMediumCheck6();
                    if (attemptWord == guessWord)
                    {
                        await Task.Delay(2500);
                        var win = new WinScreen(guessWord);
        ...
        private void game1FilipinoMedium_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
