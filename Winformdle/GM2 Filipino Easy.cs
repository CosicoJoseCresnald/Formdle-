...
{
    public partial class game2FilipinoEasy : Form
    {
        public static Dictionary<char, Button> letterButtons { get; private set; }
        public game2FilipinoEasy()
        {
            InitializeComponent();
        ...
        {
            Remove_Character.GM2FilipinoRemoveCharEasy();
        }
        ...
        private void game2FilipinoEasy_Load(object sender, EventArgs e)
        {
        ...
        private void game2FilipinoEasy_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
